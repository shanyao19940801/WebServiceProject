...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.yao.webserviceclient.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8088//services/example/HelloWorld";
    ...
    public com.yao.webserviceclient.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.yao.webserviceclient.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.yao.webserviceclient.HelloWorldSoapBindingStub _stub = new com.yao.webserviceclient.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.yao.webserviceclient.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.yao.webserviceclient.HelloWorldSoapBindingStub _stub = new com.yao.webserviceclient.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
